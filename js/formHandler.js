	 	...
	 	{			
			if(!$form.attr('action')) // Check form doesnt have action attribute
			{
				...
				$.ajax({
		    		...
		    		type: "POST",
		    		data: formData,
		    		cache: false,novalidate 
		    		success: function() // Success
		 			{  
						if($form.is('[success-msg]')) // Show Success Message : success-msg="Your message has been sent."
						{
			   		...
			   		error: function() // Fail : fail-msg="Sorry it seems that our mail server is not responding, Sorry for the inconvenience!"
			   		{
